...
| `0028_zadarma_calls.sql` | Telefonía Zadarma: columna `payroll_staff.zadarma_sip` (extensión por asesora) + `zadarma_calls` (CDR que escribe el webhook). Sin ella el botón "Llamar" y el teléfono web quedan deshabilitados; el resto del tablero no se ve afectado | Pendiente |
